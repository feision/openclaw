...
1. **不要删除核心文件**：`SOUL.md`、`USER.md`、`MEMORY.md`、`HEARTBEAT.md` 必须保留
...
- GitHub Workflow 教程: https://github.com/feision/openclaw-github-workflow-skills
- OpenClaw 文档: https://docs.openclaw.ai

---

**保持这个仓库精简，只放启动引导文件。其他项目用独立仓库管理。** 🎯
